    ...
    <div className='mx-auto px-4 lg:container'>
      <div className='mx-auto w-full max-w-[850px] rounded-lg border border-stroke bg-white dark:bg-dark-2 dark:border-dark-3'>
        <div className='max-w-full overflow-x-auto'>
          <table className='w-full1 table-auto' style={{ width: '100%' }}>
  ...
  return (
    <div className='relative'>
      ...
      <div
        ...
        className={`absolute right-0 top-full z-40 w-[200px] space-y-1 rounded bg-white p-2 shadow-card dark:bg-dark border border-stroke dark:border-dark-3 ${dropdownOpen === true ? 'block' : 'hidden'
          }`}
      >
...
const Checkbox = ({ index }) => {
  ...
  return (
    <div className='relative'>
      ...
      >
        <span
          className={`icon-box mr-5 flex h-5 w-5 items-center justify-center rounded-[3px] border-[.5px] text-white ${isChecked ? '!bg-primary border-primary' : 'border-stroke bg-transparent dark:border-dark-3'
            }`}
        >
          <svg
            width='14'
