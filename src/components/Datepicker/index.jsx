...
export default function DatePicker1() {
  ...
  const renderCalendar = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      ...
      dayDiv.className =
        "flex h-[38px] w-[38px] items-center justify-center rounded-[7px] border-[.5px] border-transparent text-dark hover:border-stroke hover:bg-gray-2 sm:h-[38px] sm:w-[38px] dark:text-white dark:hover:border-dark-3 dark:hover:bg-dark mb-2";
  ...
  return (
    <section className="relative z-[999]">
          <label className='mb-[10px] block text-xs font-medium text-dark dark:text-white text-[#404145]'>
          ...
          <div className="relative">
            <input
              ...
              className="h-[52px] w-full appearance-none rounded-lg  text-sm border border-stroke bg-white pl-4 pr-12 text-dark outline-none focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-white"
              value={selectedDate || ""}
              readOnly
            ...
            <span
              id="toggleDatepicker"
              onClick={handleToggleCalendar}
              className="absolute inset-y-0 right-0 flex h-12 w-12 items-center justify-center text-dark-5"
            >
              <svg
                width="21"
                height="20"
          ...
          {isCalendarOpen && (
            <div
              ...
              className="flex w-full flex-col rounded-xl bg-white p-4 shadow-four sm:p-[30px] dark:bg-dark-2 dark:shadow-box-dark absolute"
            >
              <div className="flex items-center justify-between pb-4">
                <button
                  id="prevMonth"
                  className="flex h-[38px] w-[38px] cursor-pointer items-center justify-center rounded-[7px] border-[.5px] border-stroke bg-gray-2 text-dark hover:border-primary hover:bg-primary hover:text-white sm:h-[38px] sm:w-[38px] dark:border-dark-3 dark:bg-dark dark:text-white"
              ...
              <div className="grid grid-cols-7 justify-between text-center pb-2 pt-4 text-sm font-sm capitalize text-body-color sm:text-lg dark:text-dark-6">
                <span className="flex h-[38px] w-[38px] items-center justify-center sm:h-[38px] sm:w-[38px]">
                  Mo
                </span>
