      ...
      <div className="container mx-auto">
        ...
        <div className="bg-white dark:bg-dark-2">
          ...
          <div className="w-full lg:w-1/2">
              <div className="bg-[url('../src/assets/sign-up.jpg')] bg-center relative h-full w-full overflow-hidden  rounded-tl-lg rounded-bl-lg lg:h-[600px]">
            ...
            <div className="w-full lg:w-1/2">
              <div className="w-full px-6 py-14 sm:p-[70px] sm:px-12 xl:px-[90px]">
                <button onClick={()=>navigate("/SetPassword")}
                      type="button" className="w-11 h-11 bg-slate-200 rounded mb-3 flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
<path d="M3.8284 6.77822L9.1924 1.41421L7.7782 0L0 7.77822L7.7782 15.5563L9.1924 14.1421L3.8284 8.77822H16V6.77822H3.8284Z" fill="black"/>
</svg>
</button>
                ...
                <form>
                  ...
                  />
                   ...
                   <div className="flex mt-3 text-sm font-normal text-slate-500">We’ve sent a six digit code to verify your email.</div>
                   <button className="flex justify-self-end	 mt-4 text-base text-blue-600 hover:text-primary dark:text-dark-6">Resend OTP</button>
                  <div className="mt-8">
                  <button onClick={()=>navigate("/SetPassword")}
                      type="button"
